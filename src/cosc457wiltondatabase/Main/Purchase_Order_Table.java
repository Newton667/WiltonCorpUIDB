 ...
 * @author Sara
 */
public class Purchase_Order_Table extends javax.swing.JFrame {

    /**
     * Creates new form Purchase_Order_Item
     */
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Purchase Order Table");
    ...
    private void jButtonShowTable2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonShowTable2ActionPerformed
        ...
        purchase_Order_Table.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Purchase_Order_Table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Purchase_Order_Table().setVisible(true);
            }
        });
    }
